...
| `CoreDesignSystemDemo` | 공용 컴포넌트 데모 | DEV와 동일 |
| `CoreStorageDemo` | 저장 동작 확인 + 호스트 테스트 숙주 | DEV와 동일 |
...
| 동시성 | Swift 5, unstructured `Task { }` | Swift 6 strict `complete`, `ManagedTask`(재진입/deinit 취소 규칙), Sendable 경계 |
